...
/**
 * 内联 SVG 图标集（Lucide 风格，outline，24 视区）。
 *
 * 统一 1.8 描边与 currentColor，避免引入图标库体积，
 * 同时满足「不用 emoji 当图标」的交付要求。
 */
...
const PATHS: Record<string, string> = {
  ...
  credentials: '<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/><path d="M3 12c0 1.66 4 3 9 3s9-1.34 9-3"/>',
  keys: '<circle cx="7.5" cy="15.5" r="4.5"/><path d="M10.8 12.2 21 2"/><path d="M15.5 6.5 18 9"/>',
  playground: '<path d="M22 2 11 13"/><path d="M22 2 15 22l-4-9-9-4z"/>',
  ...
  key: '<circle cx="7.5" cy="15.5" r="4.5"/><path d="M10.8 12.2 21 2"/><path d="M15.5 6.5 18 9"/>',
